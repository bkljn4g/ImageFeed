...
struct ProfileResult: Codable {
    ...
    let lastName: String? // обрабатываем как опционал, потому что фамилия может быть не указана
    let bio: String? // обрабатываем как опционал, потому что информация может отсутствовать
